#ifndef __SYM_JSONHELPER_H
#define __SYM_JSONHELPER_H
...
#define JSON_ADD_BOOL(parent, key, val)                                      \
    json_object_object_add(parent, key, json_object_new_boolean(val));
...
#define JSON_GET_BOOL(parent, key, val, errmsg)                             \
    {                                                                       \
        json_object* myobj;                                                 \
        JSON_GET_OBJ(parent, key, myobj, errmsg);                           \
